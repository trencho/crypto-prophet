...
from definitions import DATA_EXTERNAL_PATH, DATA_PROCESSED_PATH, DATA_RAW_PATH, coins, environment_variables, LOG_PATH, \
...
async def fetch_data() -> None:
    ...
    for coin in coin_list:
        ...
        dataframe.to_csv(path.join(DATA_EXTERNAL_PATH, coin["symbol"], "data.csv"), index=False)
