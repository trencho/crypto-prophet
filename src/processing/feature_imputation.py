...
async def distance_matrix(
    data, numeric_distance="euclidean", categorical_distance="jaccard"
):
...
async def knn_impute(
    ...
    distances = await distance_matrix(
        attributes, numeric_distance, categorical_distance
    )
